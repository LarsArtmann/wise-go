...
- **API docs study** — Full changelog + API reference analysis at `docs/reviews/2026-08-08_api-docs-study.md`. The Wise API has ~135+ endpoints across 29 categories; the SDK covers 3. This doc is the reference for prioritizing API surface expansion.
