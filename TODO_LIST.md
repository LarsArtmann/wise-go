...
`[0.11.0]` section. Source: `docs/status/2026-09-13_15-41` §b.4, re-verified
2026-09-16.
...
`docs/status/2026-09-13_14-16` §f.13–14, `_15-41` §f.7; verified still
`@latest` 2026-09-16.
...
Carried since `docs/status/2026-08-08_05-15`.
...
(2026-08-19_17-14 g.2, 18-15 g.2, 09-50 g.3, 20-57 f.5, 22-31 d.1). The v1.0
...
`docs/status/2026-09-13_15-41` §b.3/§f.6.
...
Sources: `docs/status/2026-08-08_12-27` §f.7–13, `_14-16` §f.19.

[ ] Add `.github/SECURITY.md` — a published SDK should carry a vulnerability
reporting path. Source: `docs/status/2026-09-13_15-41` §f.35.
...
ROADMAP/audit-doc count claims. Source: `docs/status/2026-09-13_15-41` §d.1/§f.11.
...
use separate `-count=1` runs). Sources: `_15-41` §b.6/§f.12/§f.15.

[ ] Quality micro-batch (each ≤30 min; sources: `_20-57` §f.30–31/§f.33,
...
and annotated in the corresponding `docs/status/2026-09-13_*` reports.
