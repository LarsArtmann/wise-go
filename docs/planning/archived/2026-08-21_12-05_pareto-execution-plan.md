...
| ~~24~~ | ~~Sandbox integration-test workflow~~ done — workflow + key-gated tests shipped (`ecdc738`); the live run remains key-gated (TODO_LIST P2) | Rest   | Critical | 90     | **BLOCKED: needs sandbox API key**        | user key             | —                 |
